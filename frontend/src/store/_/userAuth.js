  ...
  actions: {
    ...
    async useLogin(path, data) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          //Esqueceu a senha
            ...
            appStore.globalMsg(
              'Se você tem um usuário no EisnteinPertencer, receberá um email com o link para Resetar sua Senha.',
              'success',
            )
          }
        })
      ...
      if (path != '/chgpsw') {
        //Cápsula do tempo
        axios
          .post(this.serverUrl + '/loadcapsule', { username: data.username })
          ...
          .catch(function (error) {
            ...
            console.error(error)
            appStore.globalMsg(
              'Oops! As informações sa cápsula do tempo não foram carregadas.',
              'error',
            )
          })
      }
